...
func (i *ReconcileIteration) validate(hbiSchema string) (isValid bool, mismatchRatio float64, mismatchCount int64, hostCount int64, err error) {
	...
	inventoryTableName := hbiSchema + ".hosts"
